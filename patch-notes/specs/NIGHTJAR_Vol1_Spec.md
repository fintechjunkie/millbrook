# The Nightjar, Volume 1: Flip Book Spec

Source: `NIGHTJAR_Part_1_v1.md`  
Chapter: Part One: Taco Tuesday  
Spreads: 10 (9 text spreads plus 1 chapter opener) | Images: 10 | Words: 1939  
...
Images: 10. Character-led 9, establishing 1, detail 0.

**Set hard against character and action on author instruction, 2026-08-07.** Nine of the ten plates are people doing something: a boot on a bumper, a robot stepping through a wall, a grocer shoving club soda across a counter, a man standing on a parapet. The one establishing shot is the chapter opener, which exists to put the water tower at one end of the town and the Main Street roofline at the other, because the whole arc is later spent travelling between them.

## Location map, made before any prompt was written

| Plate | Place | New to the series |
|---|---|---|
| `n1-opener` | Millbrook wide, from the edge | — |
| `n1-s01` | Rosa's truck, evening, wide | **yes** |
| `n1-s02` | Rosa's truck, the hatch, close | — |
| `n1-s03` | Jennings' store at 2am, no reference | **yes** |
| `n1-s04` | A domestic bathroom, no reference | **yes** |
| `n1-s05` | A child's bedroom, no reference | **yes** |
| `n1-s06` | Felix's living room | **yes** |
| `n1-s07` | Rosa's truck, morning, shut | — |
| `n1-s08` | Main Street, looking up | **yes** |
| `n1-s09` | Main Street, the sidewalk | — |

Seven distinct places in ten plates, five of them new to the series. **Rosa's truck takes three and that is deliberate rather than unnoticed**, because the volume opens there, turns there and ends its middle act there. The three are separated on every axis available: a wide golden-hour group shot, a tight two-face close-up at the hatch where almost no truck is visible, and a flat grey morning with the hatch shut and the lot empty. Main Street takes two, one looking steeply up and one along the sidewalk.

## New faces, and where each one lands

| Who | Plates | Note |
|---|---|---|
| Rosa Delgado | s01, s02, s07 | Her whole arc: pleased, astonished, shut. |
| Mr. Jennings | s03 | Third arc, first appearance in a plate. |
| Milo's mother | s04 | One use, described inline, no token. |
| Chet | s05, s06 | The first robot the reader meets in this arc. |
| The nine-year-old | s05 | One use, unnamed, described inline. |
| The film's Nightjar | s06 | On the television. The source of everything. |
| The Nightjar | s08, s09 | Far in s08; only a hand in s09. |

**Cast size is capped at three named figures per plate, and that is the lever rather than a preference.** Understudies spread 2 lost Vex from a six-figure crowd five times running and replaced her with an invented boy each time; she renders perfectly whenever she is the subject. So the crew is never all in frame at once here, and every plate names its exact headcount in a hard constraint.

**The Nightjar is kept far, and this volume is where that costs the least.** He is small against the sky in s08 and reduced to one hand over a parapet in s09. The roster records why: with the goggles on and the cap low he is still recognisably Felix, and the reader's certainty should grow on the same curve as Pip's investigation rather than arriving all at once on his first appearance.

Every plate depicts a beat from its own text page and never that page's final beat, which is the rule all ninety-two delivered plates in the first two arcs follow.

Page budget, for whoever edits this next. Chunked with the model in `WRITING_GUIDE.md` at an ideal of 28 lines: 9 text pages running 16 to 26 lines, which is 46 to 75 per cent of the column. The short pages are deliberate: each one ends on a landed line rather than mid-scene.
---
...
### Part One: Taco Tuesday

### Image, full bleed across both pages

Slug: n1-opener
Shot type: Establishing (full bleed, both pages)
Depicts: Millbrook on an ordinary Tuesday evening, before any of it. No story beat.
Spoiler check: PASS. A chapter opener precedes all prose. Deliberately shows no truck, no gravel lot, no figure on any roof and nobody at all — the truck is beat 1 of text page 1 and the man on the parapet is the reveal on text page 8. It establishes only the geography the whole arc runs on: the water tower at one end and the Main Street roofline at the other.
...
{{STYLE}}
{{LOC:MILLBROOK_WIDE}}
A small flat town of low single-storey houses on a grid of wide streets, mature trees between them, seen from a slight elevation on its edge. A short commercial main street of two- and three-storey brick frontages runs through the middle distance with its lights just coming on, and a municipal water tower on braced steel legs stands beyond the treeline at the far end of it. The two are the furthest apart things in the frame and both are clearly readable.
Empty streets. No vehicles, no figures of any kind and nobody on any roof.
Early evening in spring, the light going long and gold, the sky clear.
Wide establishing panorama from a slight elevation, deep focus, level horizon, nothing cropped.
Low warm evening sun raking across the grid from one side, long soft shadows, every roofline and the tower clearly readable.
{{NEGATIVE}}
Aspect ratio: 2:1
```

Alt text: A small town of low houses seen from its edge at golden hour, a short main street of brick frontages with its lights coming on and a water tower standing beyond the trees at the far end.

---

## Spread 1

Pages 3 to 4 | Part One: Taco Tuesday | Words 216

### Text page (left), verbatim

### Rosa’s Truck

Rosa Delgado parked at the little league field on Tuesdays, and on Tuesdays half of Millbrook ate dinner standing up in a gravel lot.

She’d been doing it for four years out of a white truck with a hand-painted sign, and she knew everybody’s order, and she knew everybody’s mother. If you wanted to find somebody in this town on a Tuesday evening, you didn’t call them. You went and stood in her line.

The crew got there at six. Vex was already there, which is how it always works.

“You ordered without us,” Owen said.

“I ordered for all of you, and you can pay me back or you can starve.” Vex had one foot up on the bumper of somebody’s parked car. “Rosa, tell him what he’s having.”

“Two carnitas, no onion, because you don’t like the way they feel,” Rosa said through the window. “Milo, three al pastor. Lena, the fish, and yes, I know you always get the fish, and yes, I made extra for you.”

“You’re my favorite person in this town,” Lena said.

“I know that, mija.”

Felix was over at the side of the truck with his head under the awning, doing something to the generator with a screwdriver he had not asked permission to bring.
...
{{CHAR:VEX}}
{{CHAR:OWEN}}
EXACTLY THREE FIGURES AND NOBODY ELSE. Early evening at the food truck, in the middle of an order that was placed without asking anyone.
VEX is the subject and she is mid-move: **one boot planted up on the front bumper of a parked car** beside the truck, leaning her weight forward onto that knee, an armful of wrapped food held against her chest, her head turned back over her shoulder to call something at the other two. Entirely pleased with herself.
ROSA leans out through the raised serving hatch on her forearms, mid-sentence, one hand lifted off the sill counting something off on her fingers. She is enjoying this and she is not hurrying.
OWEN stands at the hatch with one hand already out for his food, looking sideways at Vex with his eyebrows down — not angry, itemising a grievance.
The awning is out, the hatch light is on, the generator is running at the back of the truck.
...
Alt text: A girl with green hair rests one boot on a car bumper with an armful of food, calling back at a boy waiting at the hatch of a food truck, while the woman inside leans out counting off an order on her fingers.

---

## Spread 2

Pages 5 to 6 | Part One: Taco Tuesday | Words 229

### Text page (left), verbatim

“Felix, get out of there.”

“Rosa, your voltage is sagging. Every time your fryer kicks on, your lights dim. Do you hear that noise it makes? That’s not a noise a generator should make.”

“That noise has been there two years.”

“That noise is a warning. You want me to look at it properly?”

“I want you to eat a taco.”

“I can do both,” Felix said, and did.

Pip stood a little apart from all of it with a plate she was holding rather than eating from. Then she took one bite, put the plate down and said, “There is cumin, oregano, garlic, orange, and something that has been in a pot for six hours. Also the tortillas came from a bag with a green stripe on it.”

Rosa leaned out the window and stared at her.

“That’s exactly right,” she said.

“I am usually right about this.”

“You come back Thursday, honey. I want to see you do that with the mole.”

The generator ran rough at seven o’clock and Rosa lost power for about an hour, which meant the warmer went cold and came back on again. Nobody thought anything about it. There were eleven people in line and she didn’t want to send them home.

Later on, every adult in Millbrook would have a theory about what happened, and the actual answer was that boring.
...
{{WARDROBE:ROSA_A}}
{{CHAR:PIP}}
EXACTLY TWO FIGURES AND NOBODY ELSE, and this is a CLOSE shot: only the serving hatch and a short stretch of the truck's flank are in frame, with the two faces filling most of it.
PIP stands at the hatch, upright and completely level, holding a paper plate down at her side with one bite gone out of what is on it. Her head is straight, her mouth is closed, her eyes are open and pointed at nothing in particular. She has just said something flatly and is not aware it was remarkable.
ROSA has come right out through the hatch on her forearms to look at her properly — head forward, eyebrows up, mouth slightly open, caught between astonishment and delight. She is looking directly at Pip and Pip is not looking back.
The whole subject of the picture is the difference between the two faces.
...
Alt text: A robotic girl stands at a food truck window holding a plate with one bite taken, her face doing nothing, while the woman inside leans right out to stare at her in astonishment.
...
So the adults did what adults do, which is take charge of a situation they do not understand.

Ida Prewitt started calling people at one in the morning to tell them not to panic, which woke up nine households that had been sleeping fine. Mr. Jennings drove to the store in his slippers and opened up at two so people could buy ginger ale, and by three he was out of ginger ale, and by three thirty he was selling club soda and telling people it was the same thing. Aunt Carol made a pot of something with rice in it that Lena would not describe afterward. Somebody put a message on the town’s emergency phone line, which nobody in Millbrook knew existed, saying that the situation was under control and that residents should stay hydrated and await further guidance. The Mayor’s name was on it four times.
...
{{CHAR:MR_JENNINGS}}
{{WARDROBE:JENNINGS_A}}
ONE NAMED FIGURE. A small-town grocery store open in the middle of the night, described here because it has no reference image: a narrow checkout counter with an old till, shelving behind it, a chest cooler along one wall, fluorescent tubes overhead, a glass front door with black windows beyond it.
MR. JENNINGS is behind the counter, mid-handover: **both hands pushing a four-pack of plain club soda bottles across the counter** toward a customer, leaning forward over it, mouth open mid-sentence, eyebrows up, entirely earnest. He is explaining something he does not believe.
**He is wearing SLIPPERS** — soft tartan house slippers, plainly not shoes — and they must be visible below the counter. He came straight from bed.
The shelf behind him where the ginger ale was is CONSPICUOUSLY EMPTY, a clean gap with price labels and nothing on it.
Two or three ordinary townspeople wait in a short queue at the counter in dressing gowns and coats thrown over nightclothes, seen from behind and to one side, faces away from camera or soft, none of them a named character.
...
Alt text: A grocer in an apron and house slippers pushes a pack of club soda across his counter at two in the morning, explaining something earnestly, with an empty shelf behind him and a short queue of people in dressing gowns waiting.

---

## Spread 4

Pages 9 to 10 | Part One: Taco Tuesday | Words 197

### Text page (left), verbatim

Vex had it worst and complained least. Owen catalogued his symptoms in a notebook until his handwriting stopped being handwriting. Milo, who never gets sick, got sick, and his mother sat on the edge of the bathtub with him and told him about a wedding in 1996.

Felix had the couch, a blanket, a bucket he was insulted by, and the box of VHS tapes he’d bought for two dollars at the church rummage sale in April.

He put one in around three because he couldn’t sleep. The label was written in marker and the tape was a 1987 movie called *The Nightjar*, and it opened with a man on a fire escape narrating his own life to nobody.

Felix got about forty minutes in before he fell asleep sitting up with the tape still running.

Pip did not get sick, because Pip does not get sick. She spent the whole night sitting in the Warehouse with her hands flat on her knees, listening to a town be miserable through its wires, and around four she heard something else start up underneath it.

“Something is opening,” she said out loud, to a room with nobody in it.
...
Alt text: A boy in a beanie and red-lensed glasses sits on a bathroom floor against the tub in the middle of the night while his mother sits on the rim beside him, mid-story, one hand raised, plainly enjoying herself.

---

## Spread 5

Pages 11 to 12 | Part One: Taco Tuesday | Words 205

### Text page (left), verbatim

### Eleven Bedrooms

The first one was on Larkspur.

A door appeared in the wall of a nine-year-old’s bedroom, about four and a half feet tall, where no door had been. It opened. A three-foot robot came through it, gray and scuffed and dented at one hip, with a spray of stiff blond hair coming off the top of his head like somebody had glued a paintbrush up there.

He had a clipboard.

“Sorry,” Chet said. “Sorry. Go back to sleep, this takes about four seconds.”
...
Alt text: A small three-foot robot with a clipboard steps through a low doorway that has opened in a child's bedroom wall, apologising, while a nine-year-old sits bolt upright in bed staring at him.

---

## Spread 6

Pages 13 to 14 | Part One: Taco Tuesday | Words 250

### Text page (left), verbatim

“You fixed my ears,” she said.
...
“Good. You’re fine now anyway. That was the four seconds.”

Cassie sat up. Her stomach had stopped hurting.

He got to Felix’s house at twenty to six, second from last on the list, and he was tired in whatever way a machine gets tired.

The living room was blue and flickering. The television was still going. On the screen a man in a mask was standing on a rooftop in the rain, and he was saying that the guilty flinch, and that the flinch is a confession.

Chet stopped and watched for a second, because he had never seen anything like it.

Then he did the work. Four seconds, same as always.

He wrote the last name on the list, and he looked around the room at the tools on the coffee table and the half-built thing on the floor with wire coming out of it, and he thought about it for a moment.

“You’re going to be fine,” he told the sleeping kid on the couch, and he meant it, and he went out through the wall.
...
```
{{STYLE}}
{{LOC:FELIX_LIVING_ROOM}}
{{CHAR:CHET}}
{{CHAR:FELIX}}
{{WARDROBE:FELIX_A}}
{{CHAR:THE_FILM_NIGHTJAR}}
THE TELEVISION IN THE ATTACHED REFERENCE IS BLANK AND OFF. HERE IT IS ON AND PLAYING, and what is on it is the subject of the picture.
ON THE SCREEN: a picture of a man in a black eye mask standing on a wet rooftop in the rain at night, in a long dark coat with the collar up, mid-speech with one hand raised. He is an adult, tall and heavy through the shoulders. The image is grainy and slightly washed, the way a worn videotape looks. **It is a PICTURE and not a display: no text, no caption, no subtitles, no channel logo, no interface and nothing legible anywhere on the screen.**
CHET stands in the middle of the carpet a few feet back from the television with his clipboard hanging forgotten at his side, **stopped mid-step and looking up at the screen**, head tilted back and slightly to one side. He has never seen anything like it. His whole posture is a small machine that has stopped doing its job for a moment.
