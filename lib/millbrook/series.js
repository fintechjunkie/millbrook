...
export const type = {
  body: {
    ...
    //
    // 34em, narrowed from 37em, does two things at once. It brings the measure
    // to about 70 characters, and because a narrower column is a taller one it
    // also fills more of the page, which was the visible complaint: too much
    // dead paper at the foot of the page.
    maxWidth: '34em',
  },
