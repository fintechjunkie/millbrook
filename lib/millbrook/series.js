...
export const ARCS = [
  ...
  },
  {
    ...
    number: 'Three',
    title: 'The Nightjar',
    tagline: 'Eleven children get better overnight, and one boy goes missing from memory.',
    blurb:
      'Half the town eats dinner standing up in a gravel lot, and by two in the morning '
      + 'eleven houses are awake and every one of them has a child on the bathroom floor. A '
      + 'three-foot robot with a clipboard fixes all eleven before dawn. By breakfast there is '
      + 'a man in a mask on the roof of the hardware '
