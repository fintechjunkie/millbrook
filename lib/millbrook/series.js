...
export const ARCS = [
  {
    ...
    band: 'sand',
    // The route into the arc page, as copy rather than as a label.
    //
    // It used to be a 9px outlined "About this arc" chip in the corner of the header, and
    // it read as a footnote — people went straight into a volume instead, which skips the
    // one page that says what the arc is and how the books work. `hint` has to give a
    // reason to go there, so it names what is on the other side.
    start: {
      label: 'Start here',
      hint: 'Where to begin, what the town already knows, and how the flipbooks work.',
    },
